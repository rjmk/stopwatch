...
asyncTest( 'repeatRender updates about ten seconds in ten seconds', function(){
	...
	repeatRender($('#counter'), new Date().getTime());
	var roundedCounter = '0';
	setTimeout(function(){
		console.log($('#counter').text().slice(3,7))
...
/*repeatRender($('#counter3'), new Date().getTime());
test('pause function clears interval', function(){
	pauseTimer();
}*/
